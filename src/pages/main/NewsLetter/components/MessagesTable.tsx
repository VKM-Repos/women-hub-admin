...
export default function MessagesTable({ columns, data }: tableProps) {
    ...
    <div className="mx-5 font-inter">
      <div className="flex items-center justify-between py-4">
        <div className="flex w-full items-center justify-between">
          <div className="flex items-center gap-14 text-sm  px-3 py-1">
            <span className="bg-[#E3FFF4] px-4 py-1 rounded-md">
              All Messages
            </span>
            <span className="bg-[#E3FFF4] px-4 py-1 rounded-md">Scheduled</span>
            <span className="bg-[#E3FFF4] px-4 py-1 rounded-md">Sent</span>
          </div>
          <div>
